                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="live-preview">
                                            <form action="{{ route('coupons.update', $updatedCoupon->id) }}"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="discount"
                                                                ...
                                                                value="{{ $updatedCoupon->discount }}" id="dicountInput">
                                                            @error('discount')
                                                                <span class="text-danger"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="date" name="start_date"
                                                                value="{{ $updatedCoupon->start_date }}" class="form-control"
                                                                id="startDate">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <span class="text-danger">*</span>
                                                            <input type="date"
                                                                value="{{ $updatedCoupon->expire_date }}"
                                                                name="expiry_date" class="form-control" id="expiryDate">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            <input type="checkbox" name="is_available" id="isAvailable"
                                                                {{ $updatedCoupon->is_available == 1 ? 'checked' : '' }}>
                                                            <label for="isAvailable" class="form-label">IS
                                                                AVAILBLE</label>
                                                        </div>
                                                    </div>
                                                    <hr>
