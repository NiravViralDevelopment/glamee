                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="live-preview">
                                            <form action="{{ route('service.update', $updatedService->id) }}"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" name="name"
                                                                value="{{ $updatedService->name }}" placeholder="Enter name"
                                                                id="firstNameinput">
                                                            @error('name')
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <span class="text-danger">*</span>
                                                            <input type="text" value="{{$updatedService->description}}" class="form-control" name="description"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <span class="text-danger">*</span>
                                                            <input type="text" value="{{$updatedService->address}}" class="form-control" name="address"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control" name="category_id" id="category">
                                                                @foreach ($categories as $category)
                                                                    <option value="{{ $updatedService->category_id }}">
                                                                        {{ $category->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <select class="form-control" name="provider_id" id="provider">
                                                                @foreach ($providers as $provider)
                                                                    <option value="{{ $updatedService->provider_id }}">
                                                                        {{ $provider->name }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="number" class="form-control" name="duration" value="{{$updatedService->duration}}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <span class="text-danger">*</span>
                                                            <input type="text" class="form-control" name="price" value="{{$updatedService->price}}"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <span class="text-danger">*</span>
                                                            <input type="text" class="form-control" name="discount" value="{{$updatedService->discount}}"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            <input type="checkbox" name="is_featured"  {{ $updatedService->is_featured == 1 ? 'checked' : '' }}
                                                                id="isFeaturedInput">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            <input type="checkbox" name="is_available" id="isAvailableInput"  {{ $updatedService->is_available == 1 ? 'checked' : '' }}>
                                                            <label for="isAvailableInput" class="form-label">IS AVAILABLE</label>
                                                        </div>
                                                    </div>
