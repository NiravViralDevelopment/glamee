                    ...
                    <div class="dropdown-menu dropdown-menu-lg" id="search-dropdown">
                        <div data-simplebar style="max-height: 320px;">
                            ...
                            <div class="notification-list">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item py-2">
                                    <div class="d-flex">
                                        <img src="{{asset('public/admin/images/users/avatar-5.jpg')}}" class="me-3 rounded-circle avatar-xs" alt="user-pic">
                                        <div class="flex-1">
                        ...
                        <a class="dropdown-item" href="auth-logout-basic.html">
                            ...
                            <span class="align-middle" data-key="t-logout">
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit" class="mdi mdi-logout text-muted fs-16 align-middle me-1"
                                            style="float:right;">
                                        Logout
                                    </button>
                                </form>
